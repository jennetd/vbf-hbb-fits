...
def ggfvbf_rhalphabet(tmpdir,
    ...
    if year != "2015":
        ...
        sys_dict['btagSFlight_2016APV'] = rl.NuisanceParameter('CMS_hbb_btagSFlight_{}'.format(year), 'lnN')
        sys_dict['btagSFbc_2016APV'] = rl.NuisanceParameter('CMS_hbb_btagSFbc_{}'.format(year), 'lnN')
    ...
    if year != "2015":
        exp_systs += ['btagSFlight_'+year,'btagSFbc_'+year]
    else:
        exp_systs += ['btagSFlight_2016APV','btagSFbc_2016APV']
