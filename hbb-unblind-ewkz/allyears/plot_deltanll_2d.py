...
if __name__ == "__main__":
    ...
    print(htemp.GetBinContent(htemp.GetXaxis().FindBin(0),htemp.GetYaxis().FindBin(0)))

    print("deltaNLL at 1,1 = ")
    print(htemp.GetBinContent(htemp.GetXaxis().FindBin(1),htemp.GetYaxis().FindBin(1)))
