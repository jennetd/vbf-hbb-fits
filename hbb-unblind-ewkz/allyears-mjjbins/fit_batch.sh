...
# Do initial fit                                                                                                                        
combineTool.py -M MultiDimFit --algo singles -d $modelfile -m 125 --robustFit 1 --cminDefaultMinimizerStrategy 0 --setParameters rVBF1=5.03,rVBF7=1,rVBF8=1,rggF=1 --freezeParameters rVBF1
