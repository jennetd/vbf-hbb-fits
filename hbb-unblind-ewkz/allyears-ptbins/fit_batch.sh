...
# Do initial fit                                                                                                                        
combineTool.py -M MultiDimFit --algo singles -d $modelfile -m 125 --robustFit 1 --cminDefaultMinimizerStrategy 0 --setParameters rggF1=1,rggF2=1,rggF3=1,rggF4=1,rggF5=1,rggF6=1,rggF7=2.07,rVBF=1 --freezeParameters rggF7
